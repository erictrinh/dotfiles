...
hs.hotkey.bind(super, '5', function() processKey(5) end)
hs.hotkey.bind(super, '6', function() processKey(6) end)
hs.hotkey.bind(super, '7', function() processKey(7) end)
hs.hotkey.bind(super, '8', function() processKey(8) end)
hs.hotkey.bind(super, '9', function() processKey(9) end)
